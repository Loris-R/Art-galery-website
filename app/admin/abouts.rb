ActiveAdmin.register About do
  ...
  #
  permit_params :first_description_en, :second_description_en, :date_design_en, :date_fair_en, :first_description_fr, :second_description_fr, :date_design_fr, :date_fair_fr
  #
  # or
  form do |f|
    f.inputs "About" do
